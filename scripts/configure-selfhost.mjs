...
if(process.env.NOTES_EMAIL_FROM)config.vars.NOTES_EMAIL_FROM=process.env.NOTES_EMAIL_FROM;
if(process.env.NOTES_EMAIL_BINDING==='true')config.send_email=[{name:'EMAIL'}];
